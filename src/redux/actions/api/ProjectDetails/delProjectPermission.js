...
export default class delProjectPermission extends API {
   constructor(projectId, timeout = 2000) {
     super("POST", timeout, false);
     this.type = constants.DEL_PROJECT_PERMISSION;
   ...
   getPayload() {
     return this.delProjectPermission;
   }
 }
