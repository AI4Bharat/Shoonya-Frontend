   ...
   dispatch(setSubtitles(sub, C.SUBTITLES));
    ...
    const tasksComplete = (id) => {
      if (id) {
        ...
        navigate(`/projects/${projectId}/SuperCheckerAudioTranscriptionLandingPage/${id}`);
      } else {
        // navigate(-1);
        // resetNotes();
        setSnackbarInfo({
    ...
    const handleSuperCheckerClick = async (
      ...
      const PatchAPIdata = {
        ...
        annotation_notes: superCheckerNotesRef.current.value,
        lead_time:
          (new Date() - loadtime) / 1000 + Number(lead_time?.lead_time ?? 0),
         result,
         ...(value==="rejected" || value==="validated" ||value==="avalidated_with_changes") && {parent_annotation:parentannotation},
      }
