...
export default memo(
  function ({ render, currentTime, duration, updatedProjectData, setUpdatedProjectData, stage }) {
    ...
    useEffect(() => {
      ...
      if (stage === 3) {
        setCurrentSubs(updatedProjectData);
      } else {
        setCurrentSubs(result);
      }
    }, [stage, updatedProjectData, result]);
      ...
      <div className={classes.parentSubtitleBox} ref={$blockRef}>
        ...
        <div ref={$subsRef}>
          {currentSubs?.map((sub, key) => {
            // Use start_time and end_time for the first element, otherwise use startTime and endTime
            const startTime = key === 0 ? DT.t2d(sub.start_time) : sub.startTime;
            const endTime = key === 0 ? DT.t2d(sub.end_time) : sub.endTime;
    
            console.log("loopsub: " + startTime);
            console.log("loopsub: " + endTime);
              ...
              <div
                ...
                style={{
                  left:
                    ...
                    (startTime - render.beginTime) * gridGap * 10,
                  width: (endTime - startTime) * gridGap * 10,
                }}
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    title={stage === 3 ? sub.acoustic_standardized_text : sub.text}
                    style={{
                  ...
                  >
                    <p className={classes.subTextP}>
                      {stage === 3 ? sub.acoustic_standardized_text : sub.text}
                    </p>
                  </div>
