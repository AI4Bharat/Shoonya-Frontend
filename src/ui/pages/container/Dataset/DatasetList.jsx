    ...
    <ThemeProvider theme={themeDefault}>
      ...
      <Grid container className={classes.root} >
        <Grid item style={{ flexGrow: "0" }}>
          <Typography variant="h6" sx={{ paddingBottom: "8px" }}>View :  </Typography>
        ...
        <Grid item style={{ flexGrow: "1", paddingLeft: "5px" }}>
          <FormControl >
            ...
            >
              ...
              <FormControlLabel value="DatasetList" control={<Radio />} label="List" onClick={handleProjectlist} />
              <FormControlLabel value="DatasetCard" control={<Radio />} label="Card" onClick={handleProjectcard} />
            </RadioGroup>
          </FormControl>
        </Grid>
      </Grid>
      ...
      <Box >
        <CustomButton sx={{ p: 2, borderRadius: 3, mt: 2, mb: 2, justifyContent: "flex-end" }}
          onClick={handleCreateProject} label="Create New Dataset Instance" />
        <CustomButton sx={{ p: 2, borderRadius: 3, mt: 2, mb: 2, ml: 2, justifyContent: "flex-end" }}
