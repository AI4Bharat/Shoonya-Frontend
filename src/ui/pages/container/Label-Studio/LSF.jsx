...
const LabelStudioWrapper = ({
  ...
  useEffect(() => {
    let sidePanel = ProjectDetails?.project_type?.includes("Audio") || ProjectDetails?.project_type?.includes("Acoustic") || !ProjectDetails?.project_type?.includes("OCRSegmentCategorization");
  ...
  function LSFRoot(
    ...
    if (taskData.task_status === "freezed") {
      interfaces = [
        ...
        "topbar",
        "instruction",
        ...(isAudioProject.current || projectType.includes("OCR") ? ["side-column"] : []),
        "annotations:history",
        "annotations:tabs",
        "annotations:menu",
        "annotations:current",
