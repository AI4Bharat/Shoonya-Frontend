...
useEffect(() => {
  getProjectsandTasks(projectId, taskId).then(
    ...
    if(labelConfig?.project_type?.includes("OCRTranscriptionEditing") || labelConfig?.project_type?.includes("OCRESTTranscriptionEditing")){
    ...
    if (userData?.id && loaded.current !== taskId) {
      ...
      getProjectsandTasks(projectId, taskId).then(
        ([labelConfig, taskData, annotations, predictions]) => {
          ...
          let tempLabelConfig = labelConfig.project_type === "ConversationTranslation" || labelConfig.project_type === "ConversationTranslationEditing" ? generateLabelConfig(taskData.data) : labelConfig.project_type === "ConversationVerification" ? conversationVerificationLabelConfig(taskData.data) : labelConfig.project_type === "OCRTranscriptionEditing" || labelConfig.project_type === "OCRTESTTranscriptionEditing" ? OCRConfigJS: labelConfig.label_config;
