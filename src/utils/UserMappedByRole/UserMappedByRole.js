...
const UserMappedByRole = (roleId) => {
    if(roleId == 1){
        ...
        return {id: roleId, name : "Manager", element : <Typography variant="caption" sx={{p:1, backgroundColor:"rgb(50, 100, 168,0.2)", color:"rgb(50, 100, 168)", borderRadius : 2, fontWeight: 600 }}>Manager</Typography>}
    } else if(roleId == 3){
