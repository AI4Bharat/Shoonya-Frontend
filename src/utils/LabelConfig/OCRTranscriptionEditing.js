export const OCRConfigJS = `<View>
  ...
  <Labels name="annotation_labels" toName="image_url" className="ignore_assertion">
    ...
    <Label value="Footer" name="Footer" className="ignore_assertion"/>
    <Label value="Header" name="Header" className="ignore_assertion"/>
    <Label value="Body" name="Body" className="ignore_assertion"/>
    <Label value="default" name="default" className="ignore_assertion"/>
